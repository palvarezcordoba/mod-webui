...
def system_page():
    ...
    logger.debug("[system] schedulers: %s", schedulers)
    logger.debug("[system] brokers: %s", brokers)
    logger.debug("[system] reactionners: %s", reactionners)
    logger.debug("[system] receivers: %s", receivers)
    logger.debug("[system] pollers: %s", pollers)
